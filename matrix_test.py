...
device.show_message("MAX7219 LED Matrix Demo", font=proportional(CP437_FONT), delay = 0.1)


time.sleep(1)
device.show_message("Brightness", delay = 0.1)
...
time.sleep(1)
device.show_message("Orientation", delay = 0.1)
...
device.show_message("Inverse", delay = 0.1)
time.sleep(1)
device.letter(0, ord('A'))
time.sleep(1)
for _ in range(10):
...
time.sleep(1)
device.show_message("Alternative font!", font=SINCLAIR_FONT, delay = 0.1)

time.sleep(1)
device.show_message("Proportional font - characters are squeezed together!", font=proportional(SINCLAIR_FONT), delay = 0.1)
...
font=proportional(TINY_FONT), delay = 0.1)

time.sleep(1)
device.show_message("CP437 Characters", delay=0.1)
...
time.sleep(1)
device.show_message("Scrolling and pixel setting...", delay = 0.1)
