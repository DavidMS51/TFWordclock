...
void setup() {
  ...
  Serial.println("Tempus Fugit WordClock Application GERMAN Version");
  ...
  */
  ...
  if (! RTC.isrunning()) {
    ...
    lc.setColumn(0, 1, B10001000); // display E E
    delay(1000);
  ...
  lc.setColumn(0, 3, B00100001); // display INIT
  lc.setColumn(0, 4, B00000001); // display INIT
  lc.setColumn(0, 5, B00000001); // display INIT
  delay(1500);
  ...
  while (count < 1200)  // setup for 2 min delay
  {
    ...
    */
    ...
    if (digitalRead(button3) == LOW) {
      ...
      lc.setLed(0, 7, 6, true);     // flash * with to indicate every push or S2 or S3
      delay(250);
